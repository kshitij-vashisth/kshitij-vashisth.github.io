...
const DEMOS = [
  { title: 'Laws of Motion-1', duration: '59 min', topic: 'Classical Mechanics', level: 'NEET', videoUrl: 'https://www.youtube.com/watch?v=REPLACE_ME_1', desc: `Explains Newton's Laws of Motion in a simple, exam-focused way. Covers force, inertia, momentum, conservation of momentum, gravitational force, pseudo force, and their applications for Class 11 Physics, NEET, and JEE preparation.` },
  { title: 'Laws of Motion-2', duration: '118 min', topic: 'Classical Mechanics', level: 'NEET/JEE', videoUrl: 'https://www.youtube.com/watch?v=REPLACE_ME_2', desc: 'Builds advanced problem-solving skills using Newton\'s Laws of Motion. Covers free body diagrams, tension, pulley systems, springs, impulse, recoil, and rocket propulsion through intuitive reasoning and exam-focused applications for NEET and JEE.' },
  { title: 'Friction-1', duration: '93 min', topic: 'Classical Mechanics', level: 'NEET/JEE', videoUrl: 'https://www.youtube.com/watch?v=REPLACE_ME_3', desc: 'Builds a deep understanding of friction from everyday intuition to exam-level applications. Covers static, kinetic, and rolling friction, inclined planes, angle of friction, and problem-solving techniques essential for NEET and JEE mechanics.' },
  { title: 'Moment of Inertia', duration: '43 min', topic: 'Classical Mechanics', level: 'NEET', videoUrl: 'https://www.youtube.com/watch?v=REPLACE_ME_4', desc: 'Explores rotational inertia from first principles, showing how mass distribution affects rotational motion. Covers torque, moment of inertia, axis theorems, radius of gyration, and rolling motion with a strong focus on intuition and exam-oriented applications.' },
  { title: 'Basic Mathematics-1', duration: '100 min', topic: 'Mathematical Prerequisites', level: 'Conceptual', videoUrl: 'https://www.youtube.com/watch?v=REPLACE_ME_5', desc: 'Builds the mathematical foundation required for Physics through a focused introduction to trigonometry. Covers identities, unit circle concepts, angle formulas, sign conventions, and problem-solving shortcuts essential for NEET, JEE, and CBSE Physics.' },
