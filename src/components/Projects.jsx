...
import project11 from "../assets/projectImages/dave2.png";
import project12 from "../assets/projectImages/profjksinha.png";

//imported videos
import daveDemo from "../assets/projectVideos/Dave2.mp4";
...
const desc11 = "Dangerous Dave 2.0 is a retro-inspired 2D action platformer built in Godot, combining fast-paced gameplay with modern mechanics and a gritty, nostalgic edge. Designed around tight controls and precision movement, it features wall jumps, dashes, and a grappling hook for fluid traversal. Reticle-based aiming enables responsive combat, while traps, enemies, and environmental hazards demand sharp reflexes. Dave is a frog with problems, and he is out to get them out of his life (for good). Across handcrafted levels and cinematic cutscenes, players experience his chaotic journey through pixelated mayhem. The game’s level design balances challenge and flow, integrating modular enemy AI, reactive traps, and score-based objectives. With support for both keyboard/mouse and controller input, Dangerous Dave 2.0 adapts to player preference. Optimized for performance and scalability, the game is structured to support future content, new mechanics, and narrative expansion—delivering a dynamic, evolving platforming experience. Demo available on itch.io. Click the Link to download!";
const desc12 = "Dr. Jitendra Kumar Sinha – Neuroscientist Portfolio is a modern, high-performance web application built with React and Vite, designed to showcase the academic and scientific achievements of an accomplished neuroscientist, combining clean, responsive design with dynamic components to ensure a seamless browsing experience across devices, with animated sections and an interactive timeline bringing Dr. Sinha’s career to life while a dynamic publication listing highlights his 60+ research contributions in leading journals like The Lancet and Ageing Research Reviews, structured for clarity and engagement to balance scientific depth with accessibility and make complex topics approachable for both academics and the general audience, emphasizing speed and scalability by leveraging modular React components and optimized builds through Vite, with GitHub Pages deployment ensuring reliable global access and a layout that adapts effortlessly to mobile, tablet, and desktop, ultimately demonstrating expertise in frontend development, responsive UI design, and performance optimization while serving as a professional platform to highlight groundbreaking research in neuroscience.";

// project data
const projects = [
  { title: "Rudra's Dream", description: desc1, image: project1, video: null, link: null, isUpcoming: true },
  { title: "GloNeuro", description: desc2, image: project2, video: null, link: "https://gloneuro.org/", isUpcoming: true },
  { title: "Solarly", description: desc3, image: project3, video: null, link: "https://predict-solar-cell-materials.onrender.com/", isUpcoming: false },
  { title: "KVZCareers", description: desc4, image: project4, video: null, link: "https://kayveez-jobz.onrender.com", isUpcoming: false },
  { title: "Git Automation", description: desc5, image: project5, video: null, link: "https://github.com/kshitij-vashisth/learning_bash/blob/main/git_up", isUpcoming: false },
  { title: "BlockSnake", description: desc6, image: project6, video: null, link: "https://kshitijvashisth.itch.io/snake", isUpcoming: false },
  { title: "iTask", description: desc7, image: project7, video: null, link: "https://kshitij-vashisth.github.io/todoListReactApp/", isUpcoming: false },
  { title: "TaskForge API", description: desc8, image: project8, video: null, link: "https://github.com/kshitij-vashisth/learning_web_js/tree/main/backend-course/backend_with_prisma/chapter-4", isUpcoming: false },
  { title: "SkyVault", description: desc9, image: project9, video: null, link: "https://github.com/kshitij-vashisth/learning_web_js/tree/main/backend-course/sheryian-crash-4hr/6_skyvault", isUpcoming: false },
  { title: "MotionMuse", description: desc10, image: project10, video: null, link: "https://kshitij-vashisth.github.io/GSAPFrontEndWebsite/", isUpcoming: false },
  { title: "Dangerous Dave 2.0", description: desc11, image: project11, video: daveDemo, link: "https://kshitijvashisth.itch.io/dangerous-dave-20", isUpcoming: true },
  { title: "Dr. Jitendra Kumar Sinha – Neuroscientist Portfolio", description: desc12, image: project12, video: null, link: "https://profjksinha.github.io", isUpcoming: true }
];
      ...
      <Slider ref={sliderRef} {...settings}>
        {projects.map((project, index) => {
          ...
          return (
            <div
              key={index}
              className={`project-slide rounded-2xl relative transition-transform duration-500 ease-out ${isHovering ? 'scale-105' : 'scale-100'}`}
            ...
            >
              ...
              <div className="project-info text-center p-4">
                <h3 className="text-xl text-[#20C20E] bg-black inline-block px-3 rounded-2xl font-semibold">
                  {project.title}
                </h3>
              </div>
            </div>
    ...
    >
      ...
      {selectedProject.video ? (
        <video
          ...
          controls
          autoPlay
          className="modal-video w-full h-auto rounded-lg"
        />
      ) : (
        <img
          ...
          className={`modal-image w-full h-auto rounded-lg ${
            selectedProject.link ? 'curZur cursor-pointer' : 'cursor-not-allowed opacity-60'
          }`}
        />
      )}
      ...
      <p className="mt-2 text-[#20C20E] text-lg text-justify">
